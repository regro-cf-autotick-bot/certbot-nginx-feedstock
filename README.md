...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/certbot-nginx-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/certbot-nginx-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add certbot-nginx
# for installing globally
pixi global install certbot-nginx
```
...
It is possible to list all of the versions of `certbot-nginx` available on your platform:
...
```
pixi search certbot-nginx --channel conda-forge
```
